...
describe('CheckoutPage component', () => {
    ...
    beforeEach(() => {
        ...
        axios.get.mockImplementation((urlPath) => {
            if (urlPath === 'http://localhost:3000/api/delivery-options?expand=estimatedDeliveryTime') {
    ...
    it('displays the page correctly', async () => {
        ...
        expect(axios.get).toHaveBeenNthCalledWith(1, 'http://localhost:3000/api/delivery-options?expand=estimatedDeliveryTime');
        expect(axios.get).toHaveBeenNthCalledWith(2, 'http://localhost:3000/api/payment-summary');
